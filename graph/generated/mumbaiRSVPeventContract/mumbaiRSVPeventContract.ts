...
export class mumbaiRSVPeventContract__idToEventResult {
  value0: Bytes;
  value1: string;
  value2: Address;
  value3: BigInt;
...
export class mumbaiRSVPeventContract extends ethereum.SmartContract {
  static bind(address: Address): mumbaiRSVPeventContract {
    return new mumbaiRSVPeventContract("mumbaiRSVPeventContract", address);
  }

  idToEvent(param0: Bytes): mumbaiRSVPeventContract__idToEventResult {
    ...
    return new mumbaiRSVPeventContract__idToEventResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_idToEvent(
    param0: Bytes
  ): ethereum.CallResult<mumbaiRSVPeventContract__idToEventResult> {
    ...
    return ethereum.CallResult.fromValue(
      new mumbaiRSVPeventContract__idToEventResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toAddress(),
        value[3].toBigInt(),
